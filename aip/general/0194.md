...
**Note:** This AIP does not cover client streaming or bi-directional streaming. Client side retry behavior for the client libraries is found in [AIP-4221](https://google.aip.dev/client-libraries/4221).
