...
- The operation should be [consistent][]: the completion of a delete operation
  **must** mean that the existence of the resource has reached a steady-state
  and reading resource state returns a consistent response.
