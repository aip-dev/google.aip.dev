...
- Scripts that operates on a JSON representation of a resource after reading it
  from an API
- Tools, such as an [Declarative client][]
...
Declarative Clients describes a category of clients that
...
desired state. To determine if a set of updates was successful a declarative
