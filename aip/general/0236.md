...
- `state` changes between `ACTIVE` and `INACTIVE` when the experiment is
  started and stopped being previewed. This happens when the "preview" and
  "stopPreview" custom methods are used.
...
- **2023-04-27:** Stop method changed to StopPreview. Annotations added.
