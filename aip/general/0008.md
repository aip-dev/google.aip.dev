...
motivation for specific guidance within the AIP.
...
an easily digestible reference.

## History

The "history" section is optional, and documents events and context around
a significant edit (e.g. rewrite) of an AIP.

While the changelog is a dotted list of one-line summaries of every change to
an AIP, the history section should elaborate on significant events in a
freeform format.
