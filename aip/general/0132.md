...
- The request message **must not** contain any other required fields except 
  for `parent`, `page_size` and `page_token` fields explained above and
...
- The `next_page_token` field, which supports pagination, **must** be included
  ...
  more information, see [AIP-158](./0158.md).
...
- **2023-04-19**: Disambiguate the required fields in the request message.
