...
message Automobile {
    ...
    string name = 1;
    // The number of wheels of the automobile.
    // If this is not set when the automobile is created, the field will be given a value of 2.
    int wheels = 2;
}
```
...
message Automobile {
    ...
    string name = 1;
    // The number of wheels of the automobile.
    // If this is not set when the automobile is created, the field will be given a value of 4.
    int wheels = 2;
}
```
