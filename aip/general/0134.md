...
- The operation should be [consistent][]: the completion of an update operation
  **must** mean that all user-settable values and the existence of the resource
  have reached a steady-state and reading resource state returns a consistent
  response.
...
[aip-128]: ./0128.md
[aip-203]: ./0203.md
[consistent]: ./0121.md#consistency
[create]: ./0133.md
[errors]: ./0193.md
...
- **2023-04-01**: Adding consistency requirement.
