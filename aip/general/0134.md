...
- The operation should have [strong consistency][]: the completion of an update
  operation **must** mean that all user-settable values and the existence of the
  resource have reached a steady-state and reading resource state returns a
  consistent response.
