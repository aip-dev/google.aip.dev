...
delegated ATL responsibilities ("ATL-D") for API Infrastructure to [Hong
Zhang][] and API Design to [JJ Geewax][]. This document uses ATL and ATL-D
consistently to refer to this role.
...
digraph d_front_back {
  ...
  draft -> reviewing;
  draft -> withdrawn [style=dashed, color=grey];
  draft -> rejected [style=dashed, color=grey];
  reviewing -> approved;
  reviewing -> withdrawn [style=dashed, color=grey];
  reviewing -> rejected [style=dashed, color=grey];
  draft -> deferred [style=dashed, color=grey];
  reviewing -> deferred [style=dashed, color=grey];
  approved -> replaced [style=dashed, color=grey];
  reviewing -> replaced [style=dashed, color=grey];
}
```
...
titled `new.md`. Assign @googleapis/aip-editors as the PR reviewer.
...
[hong zhang]: mailto:hong@google.com
[jj geewax]: mailto:jjg@google.com
[jon skeet]: mailto:jonskeet@google.com
[luke sneeringer]: mailto:lukesneeringer@google.com
