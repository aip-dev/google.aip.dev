...
Structured details with machine-readable codes **must** be used if users will
need to write code against a specific aspect of the error. Error message
strings **may** change over time.
