...
temporarily unreachable. In this situation, it is still desirable to give the
user as much information as possible, while indicating that something is missing.
...
- The response **must** provide any outstanding unreachable locations or
  ...
  - If a location or resource was unreachable during pagination, but the
    ...
    the user on a later page, the final page's `unreachable` field **must**
