...
| spiffe.type | Yes      | This indicates whether the JWT-SVIDs or X509-SVIDs should be presented to the STS and depends on the configuration of the workload identity pool provider. Allowed values: "jwt", "x509". |
...
- In a future in which the Google Cloud Platform natively supports [SPIFFE Federation][3], the **type** parameter may become obsolete for auth clients to transparently switch between JWT/X.509 depending on the GCP implementation.
...
[3]: https://github.com/spiffe/spiffe/blob/main/standards/SPIFFE_Federation.md
